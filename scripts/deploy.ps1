# ============================================================================
#  远程控制服务端 - 一键部署脚本 (Windows)  [v2.0 无 QQ 依赖]
#  用法:
#    .\deploy.ps1                     # 默认: 端口8899, 后台运行
...
if ($Service -eq 'on') {
    ...
    & nssm set RemoteControlSrv AppEnvironment "RC_PORT=$Port" | Out-Null
...
Write-Host '  ─────────────────────────────────────────────'
Write-Host '  v2.0 新功能: CPU告警 / 进程消失告警 / 定时关机提醒 (App 设置界面开启)'
Write-Host ''
